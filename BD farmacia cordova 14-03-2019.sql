...
insert  into `cabecera_compra`(`id_cabecera_compra`,`id_proveedor`,`id_usuario`,`fecha_creacion`,`plazo`,`id_sucursal`,`id_tipoPago`,`iva`,`descuento`,`total`,`estado`) values (16,8,2,'2019-03-11 04:52:06','Inmediato',2,1,4.4520000,0.0000000,41.5520000,'A'),(18,14,2,'2019-03-11 05:01:30','Inmediato',2,1,2.8740000,0.0000000,26.8240000,'A');
...
insert  into `stock`(`id_stock`,`cantidad`,`id_precio`) values (1,0,42),(2,0,20),(3,0,8),(4,32,44),(5,0,13),(7,0,26),(8,0,35),(9,0,39),(10,57,27),(13,0,40);
