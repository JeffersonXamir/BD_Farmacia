...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`modulopruebamu` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `stock`(`id_stock`,`cantidad`,`id_precio`) values (1,33,42),(2,35,20),(3,33,8),(4,174,44),(5,35,13),(7,80,26),(8,73,35),(9,91,39),(10,102,27),(11,6,41);
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `edicionCompra`()
BEGIN
    END */$$
DELIMITER ;
...
BEGIN
	...
	UPDATE `cabecera_nota_pedidos` SET estado='EF' WHERE `id_cabecera_nota_pedidos`= id_cab_ped11;
