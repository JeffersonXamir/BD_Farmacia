...
insert  into `envase`(`id_envase`,`nombre`,`estado`) values (1,'FRASCO','A'),(2,'CAJAS','A'),(3,'funda','A'),(4,'unidades','A'),(5,'gg','A');
...
insert  into `productos`(`id_productos`,`nombre`,`descripcion`,`fecha_registro`,`peso`,`id_tipo`,`id_medidas`,`id_envase`,`id_marcas`,`estado`,`id_usuario`,`iva`,`cantidad_minima`,`receta`,`unidades`,`codigo_barras`) values (21,'ASPIRINA','dolores de cabeza','2018-11-16',15.50,5,4,2,1,'A',1,'NO',15,NULL,NULL,NULL),(22,'AMOXICILINA','INFECCION','2018-11-16',10.20,5,5,2,2,'A',2,'NO',24,NULL,NULL,NULL),(23,'PASTA','MEBOCAINA','2018-11-21',1.26,6,1,1,1,'A',3,'SI',14,NULL,NULL,NULL),(24,'IBUPROFENO ','DOLORES DE CABEZA,ESTOMAGO,FIEBRE','2018-11-22',0.50,11,5,2,1,'A',7,'NO',7,NULL,NULL,NULL),(25,'LEMONFLU2','RESFRIADOS ','2018-11-30',10.00,7,5,2,1,'A',2,'NO',29,NULL,NULL,NULL),(27,'tucol','jarabe para la toz','2018-12-12',15.60,2,3,1,1,'A',3,'NO',14,NULL,NULL,NULL),(28,'GAMALATE','CONCENTRACION','2018-12-13',2.60,7,1,2,1,'A',2,'0.12',15,NULL,NULL,NULL),(29,'ZALEPLA','RELAJACION','2018-12-13',2.60,11,1,1,1,'A',3,'NO',14,NULL,NULL,NULL),(30,'AFRIN','PARA DESCONGESTIONAR LA NARIZ','2018-12-18',2.36,7,3,1,1,'A',5,'NO',19,NULL,NULL,NULL),(31,'VITAMINA C','VITAMINAS','2018-12-20',0.63,5,2,3,1,'A',2,'0.12',15,NULL,NULL,NULL),(32,'OMEPRASOL','INFECCIONES','2018-12-21',2.30,5,6,2,2,'A',2,'0.12',45,NULL,NULL,NULL),(33,'TRIPLE ACCION','PASTA DENTAL','2019-01-20',1.05,10,4,2,1,'A',2,'0.12',10,NULL,NULL,NULL),(34,'ALCOHOL','LIMPIEZA CORPORAL','2019-02-25',12.00,7,3,2,1,'A',2,'',23,NULL,NULL,NULL),(35,'TERMOMETRO','FIEBRE','2019-02-25',0.23,5,4,1,1,'A',2,'0.12',34,NULL,NULL,NULL),(36,'PARACETAMOL2','PRUEBA2','2019-03-21',34.00,6,5,2,3,'A',36,'NO',35,NULL,NULL,NULL),(37,'PASTA','DENTAL','2019-03-21',0.80,10,6,2,2,'A',53,'0.12',15,NULL,NULL,NULL),(38,'APRONAX','NAPROXENO SODICO 500MG','2019-03-22',550.00,6,6,2,1,'I',53,'NO',1,NULL,NULL,NULL),(39,'SDCWD','SDCSD','2019-03-29',10.00,5,6,2,3,'A',53,'NO',23,'SIN RECETA ',NULL,NULL),(40,'AMOXICILINA1','INFECCION1','2019-03-29',10.20,5,5,4,2,'A',3,'NO',24,NULL,NULL,NULL),(41,'LACTIBON LOCION 3.5 PH','SUSTITUTO DE JABON','2019-03-29',8.00,7,1,1,1,'A',53,'0.12',3,'SIN RECETA ',NULL,NULL),(42,'ACERLET','ACERLET 500','2019-04-11',3.00,7,6,2,3,'A',53,'NO',23,'SIN RECETA ',24,NULL);
