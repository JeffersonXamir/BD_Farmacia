...
insert  into `cabecera_nota_pedidos`(`id_cabecera_nota_pedidos`,`id_proveedor`,`id_usuario`,`fecha_creacion`,`estado`,`plazo`,`forma_pago`,`iva`,`descuento`,`total`) values (85,8,2,'2019-03-11 16:51:46','EF','Inmediato','Contado',4.452,0,41.552),(86,14,2,'2019-03-11 17:01:15','EF','Inmediato','Contado',2.874,0,26.824);
